...
import (
	...
	"github.com/lasthyphen/dijetsgo/utils/crypto"
	"github.com/lasthyphen/dijetsgo/utils/logging"
	"github.com/lasthyphen/dijetsgo/vms/avm"
	avalancheGoDjtx "github.com/lasthyphen/dijetsgo/vms/components/djtx"
	...
	"github.com/lasthyphen/dijetsindexer/services/indexes/djtx"
...
func TestInsertTxInternal(t *testing.T) {
	...
	transferableOut := &avalancheGoDjtx.TransferableOutput{}
	transferableOut.Out = &secp256k1fx.TransferOutput{
		OutputOwners: secp256k1fx.OutputOwners{Addrs: []ids.ShortID{ids.ShortEmpty}},
	}
	baseTx.Outs = []*avalancheGoDjtx.TransferableOutput{transferableOut}

	transferableIn := &avalancheGoDjtx.TransferableInput{}
	transferableIn.In = &secp256k1fx.TransferInput{}
	baseTx.Ins = []*avalancheGoDjtx.TransferableInput{transferableIn}
